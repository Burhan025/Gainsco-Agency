...
add_action( 'wp_enqueue_scripts', function() {
    ...
    wp_enqueue_style( 'Barlow-Semi-Condensed', '//fonts.googleapis.com/css2?family=Barlow+Semi+Condensed:wght@400;500;600;700&display=swap', array() ); 
...
<label>Get your car insurance quote today</label>
<div class="banner-btn-wrapper">
<input id="zipcode" type="text" placeholder="Enter Zip Code" />
<span style="cursor:pointer;" id="yourlink" class="banner-button" href="/gainsco-agency/getyourquote/">Get Started Now</span>
</div>
</div>';
...
add_action('send_headers', function () {
    header("Permissions-Policy: accelerometer=*, camera=*, geolocation=*, microphone=*, usb=*");
});
